...
public class ApplJdbc {
    ...
    private static String username = "lv374";
    private static String password = "Lv374_Taqc";
	//
	// Microsoft
    ...
    private static String URL = "jdbc:mysql://10.26.34.245:3306/lv374";
	//
	// PostgresSQL
	// private static String URL =
...
//		st.execute("DELETE FROM MyUsers WHERE id=5;");
		...
		//st.execute("UPDATE Users SET FirstName='SuperName41' WHERE Login LIKE 'login%';");
		////ResultSet rs = st.executeQuery("select * from Users;");
		//
		//ResultSet rs = st.getResultSet();
		//
