...
public class UserService extends GuestService {
    ...
    public UserService(LoginResource loginResource, TokenlifetimeResource tokenlifetimeResource, User user) {
    ...
    public GuestService LogoutUser() {
        ...
        SimpleEntity simpleEntity = logoutResource.httpPostAsEntity(null, null, bodyParameters);
